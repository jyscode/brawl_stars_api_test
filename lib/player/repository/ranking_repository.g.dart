...
class _RankingRepository implements RankingRepository {
  ...
  Future<CursorPagination<RankingModel>> paginate(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CursorPagination<RankingModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CursorPagination<RankingModel>.fromJson(
      _result.data!,
      (json) => RankingModel.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
